...
class UIState(BaseModel):
    ...
    action_directive: str = Field(description="If high panic, a massive 3-4 word survival directive (e.g., 'MOVE TO ROOF'). If proxy, a calm instruction (e.g., 'Log casualty count below').")
